...
; = [EDPS] 버튼
Gui, Add, Button, x360 y185 w80 h22 hwndHEDPS vBtnEDPS gToggleEDPS +%BS_PUSHLIKE%, 개발중
...
gui, font, S7, verdana
; - [시작 프로그램 고정 버튼]
gui, add, button, x12 y10 w110 h22 gLaunchVerupdate, 업데이트 확인
...
ToggleEDPS:
{
    ...
    if (checkEDPS) {
        ...
        GuiControl,, BtnEDPS, ON 업데이트 예정
        Run, "",, EDPSPID
    } else {
        GuiControl, +BackgroundFF0000, BtnEDPS
        GuiControl,, BtnEDPS, OFF 업데이트 예정

...
; ============================================================================
; -- (1) 채널 GUI 표시 함수 --
;     사용자가 '채널' 버튼을 눌렀을 때만 호출.
;     이 GUI에서 '에피소드 제목'과 '공유 내용'을 입력받는다.
; ============================================================================
ShowChannelGui(channelName)
{
    ...
    ; 채널 GUI 초기화 (GUI 번호 2번 사용 예시)
    Gui, 2:Destroy
    Gui, 2:+AlwaysOnTop
    Gui, 2:Default

    ; 사용자가 직접 입력할 Edit (y49 위치)
    Gui, 2:Add, Edit, x12 y49 w160 h30 vepisodeTitle
    Gui, 2:Add, Edit, x192 y49 w160 h30 vshareContent

    ; 읽기 전용(Edit) - y109
    Gui, 2:Add, Edit, x12 y109 w160 h30 ReadOnly, 예시) 에피소드 제목
    Gui, 2:Add, Edit, x192 y109 w160 h30 ReadOnly, 예시) 공유 내용

    ; 각종 텍스트 라벨
    Gui, 2:Add, Text, x12  y29 w160 h20 , 에피소드 제목
    Gui, 2:Add, Text, x192 y29 w160 h20 , 공유 내용
    Gui, 2:Add, Text, x12  y89 w160 h20 , 예시) 에피소드 제목
    Gui, 2:Add, Text, x192 y89 w160 h20 , 예시) 공유 내용
    Gui, 2:Add, Text, x112 y9  w140 h20 +Center, 공유 항목 입력

    ; 확인 버튼
    Gui, 2:Add, Button, x280 y120 w80 h30 gChannelOk, 확인

    ; GUI 표시
    Gui, 2:Show, x818 y623 h159 w381, New GUI Window

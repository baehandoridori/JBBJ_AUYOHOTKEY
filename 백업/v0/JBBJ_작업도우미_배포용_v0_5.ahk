...
Gui, Font, S7, Verdana
; [파일공유_JBBJ] 버튼
Gui, Add, Button, x360 y85 w80 h22 hwndHFileShare vBtnFileShare gToggleFileShare, 파일공유_JBBJ


; [자동 한영전환] 버튼
Gui, Add, Button, x360 y110 w80 h22 hwndHAutoIME vBtnAutoIME gToggleAutoIME, 자동 한영전환


; [경로 쉽게열기] 버튼
Gui, Add, Button, x360 y135 w80 h22 hwndHEasyOpen vBtnEasyOpen gToggleEasyOpen, 경로 쉽게열기

; [AlwaysOnTop] 버튼
Gui, Add, Button, x360 y160 w80 h22 hwndHAlwaysOnTop vBtnAlwaysOnTop gToggleAlwaysOnTop, AlwaysOnTop

...
global HFileShare, HAutoIME, HEasyOpen, HAlwaysOnTop, HEDPS
...
Gui, Add, Text, x22 y199 w310 h50 , 경로 선택 후 Caps Lock 키를 두번 누르면 해당 경로가 파일 탐색기에 열립니다.
...
WM_MOUSEMOVE(wParam, lParam, msg, hwnd) {
    ...
    if (hwnd != prevHwnd) {
        ...
        if (hwnd = HFileShare || hwnd = HAutoIME || hwnd = HEasyOpen || hwnd = HAlwaysOnTop || hwnd = HEDPS)

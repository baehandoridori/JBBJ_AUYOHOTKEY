...
Gui, Add, Text, x152 y9 w160 h20 , JBBJ 작업 도우미

Gui, Font, S10 CDefault, Verdana
Gui, Add, Text, x12 y49 w340 h20 , 여러분의 작업의 편의성을 위해 제작한 JBBJ 작업 도우미입니다.
...
Gui, Add, Text, x22 y199 w310 h50 , 경로 선택 후 Caps Lock 키를 두번 누르면 해당 경로가 파일 탐색기에 열립니다. `n파일 경로를 Ctrl + C 로 복사한 후 Caps lock 키를 두 번 눌러도 됩니다.
...
; = [EDPS] 버튼
Gui, Add, Button, x360 y185 w80 h22 hwndEDPS vBtnEDPS gToggleEDPS +%BS_PUSHLIKE%, 쉬운 폴더트리
...
gui, font, S7, verdana
; - [시작 프로그램 고정 버튼]
gui, add, button, x12 y10 w110 h22, 시작 프로그램으로 설정
...
gui, font, S7, verdana
; - [디버그 모드] 버튼
gui, add, button, x360 y20 w80 h22 gLaunchDebugMode, 디버그 모드
...
Gui, Add, GroupBox, x12 y369 w140 h210 , 딴짓거리
Gui, Add, Button, x22 y399 w60 h50 gPlaySnakeGame, 딴짓하기
Gui, Add, Button, x84 y399 w60 h50 gPlaynumbergame, 딴짓하기2
...
global totalUsage, lastCheck, lastActiveProcess, usageTimes
{
   ...
   ; (B) PC가 2분 이상(120,000ms) 입력이 없으면 'afk'
   idleTime := A_TimeIdle
   if (idleTime >= 120000)
   {
       currentProcess := "afk"

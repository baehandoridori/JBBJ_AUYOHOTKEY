...
; =============================================================================
; [한영 전환 기능 초기화] - 주석처리됨 (Check 라벨 비활성화로 인해)
; =============================================================================
...
; --------------------------------------------------------------------------
; [ 한영 전환 기능 ] - 주석처리됨 (2025-01)
; --------------------------------------------------------------------------
; ※ 주석처리 이유:
;   Windows 11 새 IME 환경에서 ImmGetDefaultIMEWnd()가 정상 동작하지 않음
;   "이전 버전의 한국어 IME 사용" 설정을 해도 한영 상태 감지가 불안정함
;   → 간소화 버전(성원님버전.ahk)으로 대체 권장
; --------------------------------------------------------------------------
/*
Check:
   ; 자동 한영전환이 꺼져 있으면 스킵
